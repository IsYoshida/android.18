...
const menumsgimg = (numero, groupname, battery) => {
    return `MENU DA ANDROID No.18 COM 363 COMANDOS, BATERIA: ${battery}`
}
...
const backgroundmenuimg = `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSV4uz1yjHtJb31W3VHNxjgli3GzW6M_c21bw&usqp=CAU`
...
const banmsgporn = 'Enviando porn aqui mesmo sabendo que não pode... Adeus! (Em caso de remoção de forma injusta ou não intencional entre em contato com algum dos admins do grupo).' 
...
const notregister = `*Comando não registrado, digite ${prefix}menu no chat privado para ver a lista de comandos. Caso você envie esse comando no grupo você será removido e bloqueado imediatamente!*`
